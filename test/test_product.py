...
class TestExports:
    """ProductSpaceConv and ProductSpaceEmbedding are importable from devograph."""

    def test_product_space_conv_in_devograph(self):
        assert hasattr(devograph, "ProductSpaceConv")
        assert devograph.ProductSpaceConv is ProductSpaceConv

    def test_product_space_embedding_in_devograph(self):
        assert hasattr(devograph, "ProductSpaceEmbedding")
        assert devograph.ProductSpaceEmbedding is ProductSpaceEmbedding

    def test_product_manifold_conv_in_devograph(self):
        assert hasattr(devograph, "ProductManifoldConv")
        assert devograph.ProductManifoldConv is ProductManifoldConv

    def test_product_manifold_mlp_in_devograph(self):
        assert hasattr(devograph, "ProductManifoldMLP")
        assert devograph.ProductManifoldMLP is ProductManifoldMLP
