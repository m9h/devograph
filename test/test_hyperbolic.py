...
class TestExportAccessible:
    ...
    def test_import_from_devograph(self):
        """PoincareHypergraphConv should be importable from devograph."""
        assert hasattr(devograph, "PoincareHypergraphConv")
        assert devograph.PoincareHypergraphConv is PoincareHypergraphConv
