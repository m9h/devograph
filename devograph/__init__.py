...
C. elegans-specific tooling -- data loaders, Pando GRN loader --
built on top of the hgx hypergraph library.  General-purpose modules
(dynamics, geometry, OT, wavelets, topology, etc.) live in hgx and
are re-exported here for backward compatibility.
"""

# --- General-purpose re-exports from hgx ---
...
# --- devograph-specific: C. elegans data loaders ---
try:
